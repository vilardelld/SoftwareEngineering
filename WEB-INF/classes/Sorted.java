...
public class Sorted extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
		...
		String vi= req.getParameter("vig");
		String nam= req.getParameter("nombre");
		String gradi= req.getParameter("Grado");
		...
		String sql=null;
		if (vi!= null)  {
		 sql = "Select nombre,apellidos,grado FROM Usuarios WHERE Vigente like  '" + vi + "'";
		}
		if (nam!= null)  {
		 sql = "Select nombre,apellidos,grado FROM Usuarios WHERE  nombre like '" + nam + "' OR apellidos like '" + nam + "'";
		}
		if (gradi!= null)  {
		 sql = "Select nombre,apellidos,grado FROM Usuarios WHERE  Grado like  '" + gradi + "'";
		}
