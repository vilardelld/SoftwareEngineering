...
public class Vigentes extends HttpServlet {
    ...
    public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		toClient.println("<br>");
		toClient.println("<br>");
		toClient.println("You sucefully changed this user /Has cambiado la vigencia de este usuario");
		toClient.println("<br>");
		toClient.println("Ahora el ID" + id + ooldPassword + "esta vigente");
		toClient.println("<BR>");
		toClient.println("<BR>");
        ...
        System.out.println("Introduce a vigente");
          return;
        }
		  if(id==null) {
        ...
        try {
            ...
            ResultSet rs = null;
			String sql = "UPDATE Usuarios SET Vigente = '" + ooldPassword + "' WHERE ID like '" + id + "'";
